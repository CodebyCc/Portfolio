const projects = [
  {
    ...
    info: "Built the official webpage for NB Properties Gh. NB Properties Gh is a real estate company in Ghana that deals in the sale and building of properties such as dream homes, apartments, offices,  etc.",
